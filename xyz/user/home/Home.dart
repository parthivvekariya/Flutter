...
class HomePage extends State<Home>
{
  ...
  {
    final responce = await http.get(Uri.parse("https://roasting-conflict.000webhostapp.com/API/task/category/Category_view.php"));
                  ...
                  children: List.generate(list.length, (index) {
                    return InkWell(
                      onTap: (){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=>Category(index: list[index]['id'],category_name: list[index]['cate_name'], )));
                      },
                      child: Card(
                        elevation: 3,
                        shadowColor: kBrown,
