...
class CategoryPage extends State<Category> {
  ...
  var category_id;
  var category_nm;
  CategoryPage({@required this.category_id, @required this.category_nm});

  Future<List> viewCategoryItemsData() async{
    final responce = await http.get(Uri.parse(
        //"https://vyasprakruti.000webhostapp.com/FlutterProject/Category_images/category_images_view.php?data="
      "https://roasting-conflict.000webhostapp.com/API/task/category/category_images_view.php?data="
...
class ItemsState extends State<Items>{
  ...
  _save(var url) async {
    ...
    if(status.isGranted){
      ...
      db.insertData(CategoryModel(url: savePath, id: 0, ));
